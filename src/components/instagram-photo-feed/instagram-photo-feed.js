  ...
  <div className="col">
    <ul className="nav justify-content-center nav-pills">
      <li className="nav-item p-2">
        <a className="nav-link active fas fa-list-ul" href="#"></a>
      </li>
      <li className="nav-item p-2">
        <a className="nav-link fas fa-square"
          href="file:///C:/Users/javie/OneDrive/Escritorio/4geeks/proyectos/dia2InstagramPhotoFeedConBootstrap/instagram%20feed.html"></a>
      </li>
    </ul>
  </div>
